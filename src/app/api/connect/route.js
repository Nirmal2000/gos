...
export async function GET(req) {
    ...
    const authUrl = `https://api.notion.com/v1/oauth/authorize?client_id=${CLIENT_ID}&response_type=code&owner=user&redirect_uri=${REDIRECT_URI}&state=${encodeURIComponent(userText)}`;
